 ...
 *
 */
public abstract class AbstractReevaluatorProtectionGoals implements IReevaluatorProtectionGoals {
    private static final Logger LOG = Logger.getLogger(AbstractReevaluatorProtectionGoals.class);
