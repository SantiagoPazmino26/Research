...
import sernet.gs.ui.rcp.main.bsi.views.data.DataView;
...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
    ...
    private OpenViewAction openDataViewAction;
    ...
    protected void makeActions(final IWorkbenchWindow window) {
        ...
        this.openDataViewAction = new OpenViewAction(window, Messages.ApplicationActionBarAdvisor_47, DataView.ID, ImageCache.VIEW_BSIMODEL, ActionRightIDs.DATAVIEW);
        ...
        IAction actions[] = new IAction[]{this.exitAction, this.copyAction, this.pasteAction,
                ...
                this.testAction, this.openDataViewAction
         };
    ...
    private IContributionItem createWindowMenu(IWorkbenchWindow window) {
        ...
        viewsMenu.add(new Separator());
        viewsMenu.add(this.openDataViewAction);
        viewsMenu.add(new Separator());
