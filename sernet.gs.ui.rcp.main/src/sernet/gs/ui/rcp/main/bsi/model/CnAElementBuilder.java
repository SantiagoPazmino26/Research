...
public final class CnAElementBuilder {
	...
	public CnATreeElement buildAndSave(ITVerbund itverbund, String typeId) throws Exception {
		...
		else if (Data.TYPE_ID.equals(typeId)) {
			CnATreeElement category = itverbund.getCategory(DataKategorie.TYPE_ID);
			return CnAElementFactory.getInstance().saveNew(category, Data.TYPE_ID, null, false);
