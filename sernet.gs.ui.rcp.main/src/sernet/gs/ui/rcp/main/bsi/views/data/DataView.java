 ...
 * 
 * Contributors:
 *     Santiago Pazmino - initial API and implementation
 ******************************************************************************/

package sernet.gs.ui.rcp.main.bsi.views.data;
...
/**
 * View for a tree structure, representing the data model for Data
 * 
 * @author Santiago Pazmino *
 */
public class DataView extends RightsEnabledView
        implements IAttachedToPerspective, ILinkedWithEditorView {

    private static final Logger LOG = Logger.getLogger(DataView.class);

    public static final String ID = "sernet.gs.ui.rcp.main.views.data.dataview"; //$NON-NLS-1$
